    ...
    "paths": {
        "/admin/users": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Показывать ли мягко удалённых",
                ...
                "responses": {
                    ...
                    "401": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/internal_handler.ErrorPayload"
                        }
                    },
                    "403": {
        ...
        "/admin/users/{id}/block": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "blocked: true|false",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/admin/users/{id}/role": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "role: user|moderator|admin",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/auth/logout": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "refresh_token (опционально)",
                        "name": "body",
                        "in": "body",
                        "schema": {
        ...
        "/auth/reset-password": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "недействительный/истёкший токен",
                        "schema": {
                            "$ref": "#/definitions/internal_handler.ErrorPayload"
                        }
                    },
